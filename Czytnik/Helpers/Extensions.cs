...
namespace Czytnik.Helpers
{
    ...
    {
        public static string ActiveClass(this IHtmlHelper htmlHelper, string controllers = null, string actions = null, string cssClass = "navigation__links-item--active")
        {
